...
export const PROMO_LLM_PROMPT_VERSION = 'full-promo-extraction-v4-json-mode'
...
function buildPromptInput(request) {
  ...
  return [
    request.input,
    '',
    'Return one JSON value that follows this schema semantically. The application will validate every field after generation.',
