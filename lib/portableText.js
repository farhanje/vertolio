...
import {getQrisPrototypePreset} from './qrisPrototypePresets'
import {getKybAiPrototypePreset} from './kybAiPrototypePresets'
import {getOcrPrototypePreset} from './ocrPrototypePresets'
...
function prototypeProps(value = {}) {
  ...
  const preset =
    getPrototypePreset(value?.preset) ||
    getQrisPrototypePreset(value?.preset) ||
    getKybAiPrototypePreset(value?.preset) ||
    getOcrPrototypePreset(value?.preset)
  return {
