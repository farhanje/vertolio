...
import { applyTextBoundary, boundaryContractFromConfig } from './boundary'
...
export class PromotionSourceAdapter {
  ...
  getBoundaryContract() {
    return boundaryContractFromConfig(this.source?.adapter_config?.boundaries)
  }

  boundPromotionText(text, context = {}) {
    return applyTextBoundary(text, this.getBoundaryContract(context))
  }
}
