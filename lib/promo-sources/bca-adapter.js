...
export class BcaPromotionAdapter extends BoundedGenericHtmlPromotionAdapter {
  ...
  async extractPromotion(document) {
    ...
    // Publication dates and dates from related promotions must never become the
    // current offer's validity start. The bounded document already removes the
    // related-promo section; this protects legacy JSON-LD publication dates.
    if (
