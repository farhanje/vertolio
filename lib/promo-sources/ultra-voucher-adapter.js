...
const ULTRA_CATALOG_HARD_CAP = 200
const ULTRA_MAPPING_VERSION = 'ultra-catalog-v2'
...
export class UltraVoucherPromotionAdapter extends PromotionSourceAdapter {
  async discoverPromotionUrls() {
    ...
    return [...unique.values()].slice(0, ULTRA_CATALOG_HARD_CAP)
  }
  ...
  async extractPromotion(document) {
    ...
    return {
      ...
      contentHash: sha256Hex(`${ULTRA_MAPPING_VERSION}|${merchant}|${percentage}|${relevantText}`),
      ...
      boundaryDiagnostics: {
        ...
        endSatisfied: true,
        truncated: false,
        sourceMapping: {sourceMappingVersion: ULTRA_MAPPING_VERSION},
      },
      extractedFields: {
        title,
        merchant,
        ...
        sourceMappingVersion: ULTRA_MAPPING_VERSION,
