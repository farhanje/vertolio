...
export const SITE_SETTINGS_QUERY = groq`*[_type=="siteSettings"][0]{
  ...
  heroTickerWords,
  heroPortraitDesktop{..., alt, asset->{url}},
  heroPortraitMobile{..., alt, asset->{url}},
  about{
    kicker,
    title,
    lead,
    ...
    body,
    images[]{caption, image{..., alt, asset->{url}}}
  },
  seo{siteTitle, siteDescription, ogImage{..., alt, asset->{url}}, commentsRepo},
  pageAccents,
